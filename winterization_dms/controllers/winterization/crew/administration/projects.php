<?php
  ...
  class WinterizationCrewAdministrationProjectsController extends Controller {
    private $d,$h;
    ...
    public function view() {
      ...
      $this->addHeaderItem($this->h->javascript('winterization/crew/administration/projects.js', 'winterization_dms'));
    ...
    private function _redirectPage() {
      $this->redirect('/winterization/crew/administration/projects');
    }
